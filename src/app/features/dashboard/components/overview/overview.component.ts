...
@Component({
  ...
  template: `
    <div class="flex py-5 flex-col">
      <h1 class="font-medium text-lg opacity-80">Joshua Hunter</h1>
    ...
    <h2 class="font-medium mt-5 opacity-80">Description:</h2>
    <p class="opacity-80">
      I am the best programmer ever in the whole wide worlds.
    </p>
    <h2 class="font-medium mt-5 opacity-80">Skills:</h2>
    <div class="grid grid-cols-6 gap-2 text-sm w-fit">
      <app-tag> VolleyBall </app-tag>
      <app-tag> VolleyBall </app-tag>
      <app-tag> VolleyBall </app-tag>
      <app-tag> VolleyBall </app-tag>
      <app-tag> VolleyBall </app-tag>
    ...
    <h2 class="font-medium mt-8 opacity-80">Rating:</h2>
